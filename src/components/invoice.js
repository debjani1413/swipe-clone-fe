...
const Invoice = () => {
    const infoData = [
        { text: "Create invoices in 10 seconds & share them with customers", icon: faCheckCircle },
        { text: "Discover templates that's perfect for your business", icon: faCheckCircle },
